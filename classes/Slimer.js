const SLIMER_X_VELOCITY = -20;
const SLIMER_JUMP_POWER = 250;
const SLIMER_GRAVITY = 580;

class Slimer {
  constructor(
    { x, y, width, height, velocity = { x: SLIMER_X_VELOCITY, y: 0 } },
    turningDistance = 100
  ) {
    this.x = x;
    this.y = y;
    ...
    this.image.src = "./images/slimer.png";
    this.elapsedTime = 0;
    this.currentFrame = 0;
    this.sprites = {
      run: {
  ...
  applyGravity(deltaTime) {
    this.velocity.y += SLIMER_GRAVITY * deltaTime;
  }
